...
def get_value_from_GLOBAL_section(user_config_whole, key_name):
    if key_name in user_config_whole[py.body.config.GLOBAL_SECTION]:
        return user_config_whole[py.body.config.GLOBAL_SECTION][key_name]
    else:
